 ...
 * 
 * @todo Подключения файлов вынести в init.php, где будет произведено подключение согласно файлу конфигурации.
 */
 ...
 * @todo Возможно, лучше сначала инициализировать CPSS, а затем, используя класс, вывести оформленное сообщение, а не просто строку.
 * @todo Так же возможно не лучшим решением будет полная остановка работы сайта. Возможно, просто отключать CPSS, если версия PHP не соответствует
 * @todo допустимой, а уведомлять только в логах, сообщениях на почту и т.д. То есть для посетителя работа должна оставаться незаметной.
 */
 ...
 * 
 * @todo Возможно, здесь при возникновении ошибки следует выводить другое сообщение или незаметно завершать работу, информируя только админа?
 */
 ...
 * Проверка проходит в несколько этапов. В начале срабатывает условие принудительной задержки скрипта,
 * заданное в файле конфигурации. Следующий этап - обнаружение прокси-сервера. Если обнаружено подключение
